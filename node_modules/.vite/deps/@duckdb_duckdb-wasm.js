...
var M = () => B() ? "node" : navigator.userAgent;
var We = () => M().includes("Firefox");
var ve = () => /^((?!chrome|android).)*safari/i.test(M());
function Be() {
...
export {
  ...
  Oe as PACKAGE_VERSION_MAJOR,
  Fe as PACKAGE_VERSION_MINOR,
  fe as PACKAGE_VERSION_PATCH,
  se as StatusCode,
  A as VoidLogger,
  ...
  i as WorkerTask,
  Qe as createWorker,
  Be as getJsDelivrBundles,
  Ee as getLogEventLabel,
  le as getLogLevelLabel,
  me as getLogOriginLabel,
  pe as getLogTopicLabel,
  ae as getPlatformFeatures,
  We as isFirefox,
  B as isNode,
  ve as isSafari,
  Me as selectBundle
